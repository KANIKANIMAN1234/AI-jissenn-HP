    ...
    subcategories: [
      {
        ...
        detailItems: [
          ...
          "第46回『Claude Code超入門 第2回｜AIに実際に動いてもらおう 　── 話しかけるだけで仕事が片付く体験』",
          "第47回『ClaudeCode超入門第3回｜ゼロから本格アプリを作る 　──コードを書かずにWebアプリが完成する様子を見てみよう』",
          "第48回『AIエージェント時代、96％の人が気づいていないもの』",
      ...
      },
      {
        ...
        detailItems: [
          ...
          "第30回 3週間集中チャレンジ企画！LINE公式アカウントで作る 「自分専用・AI家計簿アプリ」完全マスターセミナー！（第2回）",
          "第31回 3週間集中チャレンジ企画！LINE公式アカウントで作る 「自分専用・AI家計簿アプリ」完全マスターセミナー！（第3回）",
